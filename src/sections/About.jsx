    ...
    <section className="c-space section-spacing" id="about">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
        ...
        <div className="flex items-end grid-default-color grid-1">
          ...
          />
          <div className="z-10">
            <p className="headtext">Hi, I'm Sarthak Kiran Londhe</p>
            <p className="subtext">
        ...
        <div className="grid-black-color grid-3">
          <div className="z-10 w-[50%]">
            ...
            <p className="subtext">
              I'm based in Maharashtra, and open to remote work worldwide
            </p>
          </div>
        ...
        <div className="grid-default-color grid-5">
          <div className="z-10 w-[50%]">
            ...
            <p className="subtext">
              ...
              Web Development: HTML, CSS, React, Node.js, MongoDB<br/>
              Tools/Tech: Git, VS Code, Postman, Vite<br/>
              Other: Research Writing, Data Analysis, Public Speaking
            </p>
          </div>
